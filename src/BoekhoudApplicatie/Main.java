...
//        System.out.println(factuur.toString());
        ...
        Factuur factuur3 = new Factuur(3, "Auto3", 10000.0, "02-04-2022", false, 1, 900, administratie);
        //factuur1.checkBedragExcl(factuur1.getFactuurBedrag(),factuur1.getBtwCode(), factuur1.getBtwBedrag());
        System.out.println(factuur1.checkBedragExcl(factuur1.getFactuurBedrag(),factuur1.getBtwCode(), factuur1.getBtwBedrag()));
        System.out.println(factuur2.checkBedragExcl(factuur2.getFactuurBedrag(),factuur2.getBtwCode(), factuur2.getBtwBedrag()));
        System.out.println(factuur3.checkBedragExcl(factuur3.getFactuurBedrag(),factuur3.getBtwCode(), factuur3.getBtwBedrag()));
    }
}