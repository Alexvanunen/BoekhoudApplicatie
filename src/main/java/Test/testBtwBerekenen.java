...
class testBtwBerekenen {
    ...
    void TestBtwBerekenen() {
        ...
        Factuur factuur1 = new Factuur(1, "Auto", 12100.0, "02-04-2022", false, 2, 2100, administratie, true, 14, true, 30, "OmzetBelasting");
        Factuur factuur2 = new Factuur(2, "Auto2", 10900.0, "02-04-2022", false, 1, 900, administratie, true, 14, true, 30, "OmzetBelasting");
        // Expected
