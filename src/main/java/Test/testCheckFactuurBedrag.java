...
public class testCheckFactuurBedrag {
    ...
    void testCheckFactuurBedragLaag() {
        ...
        String actualResult1 = factuur1.checkFactuurBedrag();
        String expectedResult2 = "Factuurbedrag is laag";
        String actualResult2 = factuur2.checkFactuurBedrag();
    ...
    void testCheckFactuurBedragGemiddeld() {
        ...
        String actualResult3 = factuur3.checkFactuurBedrag();
        String expectedResult4 = "Factuurbedrag is gemiddeld";
        String actualResult4 = factuur4.checkFactuurBedrag();
        String expectedResult5 = "Factuurbedrag is gemiddeld";
        String actualResult5 = factuur4.checkFactuurBedrag();
    ...
    void testCheckFactuurBedragHoog() {
        ...
        String actualResult6 = factuur6.checkFactuurBedrag();
        String expectedResult7 = "Factuurbedrag is hoog";
        String actualResult7 = factuur7.checkFactuurBedrag();
