...
public class testCheckBedragExcl {
    ...
    void ConditionCoverageTestCheckBedragExcl() {
        ...
        // 1 1 1
        Factuur factuur2 = new Factuur(2, "Auto2", 12100.0, "02-04-2022", false, 2, 2100, administratie, true, 14, true, 30, "OmzetBelasting");
    ...
    void DecisionCoverageTestCheckBedragExcl() {
        ...
        // 1 1 1
        Factuur factuur4 = new Factuur(4, "Auto4", 12100.0, "02-04-2022", false, 2, 2100, administratie, true, 14, true, 30, "OmzetBelasting");
    ...
    void CDCoverageTestCheckBedragExcl() {
        ...
        // 1 1 1
        Factuur factuur6 = new Factuur(6, "Auto6", 12100.0, "02-04-2022", false, 2, 2100, administratie, true, 14, true, 30, "OmzetBelasting");
    ...
    void ModifiedConditionTestCheckBedragExcl() {
        ...
        // 1 0 1
        Factuur factuur8 = new Factuur(8, "Auto8", 12100.0, "02-04-2022", false, 2, 0, administratie, true, 14, true, 30, "OmzetBelasting");
        // 1 1 0
        Factuur factuur9 = new Factuur(9, "Auto9", 12100.0, "02-04-2022", false, 2, 2100, administratie, false, 14, true, 30, "OmzetBelasting");
        // 1 1 1
        Factuur factuur10 = new Factuur(10, "Auto10", 12100.0, "02-04-2022", false, 2, 2100, administratie, true, 14, true, 30, "OmzetBelasting");
    ...
    void MultipleConditionTestCheckBedragExcl() {
        ...
        // 0 0 1
        Factuur factuur12 = new Factuur(12, "Auto12", 12100.0, "02-04-2022", false, 0, 0, administratie, true, 14, true, 30, "OmzetBelasting");
        // 0 1 0
        Factuur factuur13 = new Factuur(13, "Auto13", 12100.0, "02-04-2022", false, 0, 2100, administratie, false, 14, true, 30, "OmzetBelasting");
        // 0 1 1
        Factuur factuur14 = new Factuur(14, "Auto14", 12100.0, "02-04-2022", false, 0, 2100, administratie, true, 14, true, 30, "OmzetBelasting");
        // 1 0 0
        Factuur factuur15 = new Factuur(15, "Auto15", 12100.0, "02-04-2022", false, 2, 0, administratie, false, 14, true, 30, "OmzetBelasting");
        // 1 0 1
        Factuur factuur16 = new Factuur(16, "Auto16", 12100.0, "02-04-2022", false, 2, 0, administratie, true, 14, true, 30, "OmzetBelasting");
        // 1 1 0
        Factuur factuur17 = new Factuur(17, "Auto17", 12100.0, "02-04-2022", false, 2, 2100, administratie, false, 14, true, 30, "OmzetBelasting");
        // 1 1 1
        Factuur factuur18 = new Factuur(18, "Auto18", 12100.0, "02-04-2022", false, 2, 2100, administratie, true, 14, true, 30, "OmzetBelasting");
