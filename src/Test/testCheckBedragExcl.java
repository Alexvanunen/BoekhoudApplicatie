...
public class testCheckBedragExcl {
    ...
    void ConditionCoverageTestCheckBedragExcl() {
        ...
        // 0 0 0
        Factuur factuur1 = new Factuur(1, "Auto4", 12100.0, "02-04-2022", false, 0, 0, administratie, false);
        // 1 1 1
        Factuur factuur2 = new Factuur(2, "Auto5", 12100.0, "02-04-2022", false, 2, 2100, administratie, true);
    ...
    void DecisionCoverageTestCheckBedragExcl() {
        ...
        Administratie administratie = new Administratie("Miniwars", "111", "222", 2);
        // 0 0 0
        Factuur factuur3 = new Factuur(3, "Auto4", 12100.0, "02-04-2022", false, 0, 0, administratie, false);
        // 1 1 1
        Factuur factuur4 = new Factuur(4, "Auto5", 12100.0, "02-04-2022", false, 2, 2100, administratie, true);
    ...
    void CDCoverageTestCheckBedragExcl() {
        ...
        Administratie administratie = new Administratie("Miniwars", "111", "222", 2);
        // 0 0 0
        Factuur factuur5 = new Factuur(5, "Auto4", 12100.0, "02-04-2022", false, 0, 0, administratie, false);
        // 1 1 1
        Factuur factuur6 = new Factuur(6, "Auto5", 12100.0, "02-04-2022", false, 2, 2100, administratie, true);
    ...
    void ModifiedConditionTestCheckBedragExcl() {
        ...
        Administratie administratie = new Administratie("Miniwars", "111", "222", 2);
        // 0 1 1
        Factuur factuur7 = new Factuur(7, "Auto4", 12100.0, "02-04-2022", false, 0, 2100, administratie, true);
        // 1 0 1
        Factuur factuur8 = new Factuur(8, "Auto5", 12100.0, "02-04-2022", false, 2, 0, administratie, true);
        // 1 1 0
        Factuur factuur9 = new Factuur(9, "Auto6", 12100.0, "02-04-2022", false, 2, 2100, administratie, false);
        // 1 1 1
        Factuur factuur10 = new Factuur(10, "Auto6", 12100.0, "02-04-2022", false, 2, 2100, administratie, true);
    ...
    void MultipleConditionTestCheckBedragExcl() {
        ...
        Administratie administratie = new Administratie("Miniwars", "111", "222", 2);
        // 0 0 0
        Factuur factuur11 = new Factuur(11, "Auto4", 12100.0, "02-04-2022", false, 0, 0, administratie, false);
        // 0 0 1
        Factuur factuur12 = new Factuur(12, "Auto5", 12100.0, "02-04-2022", false, 0, 0, administratie, true);
        // 0 1 0
        Factuur factuur13 = new Factuur(13, "Auto6", 12100.0, "02-04-2022", false, 0, 2100, administratie, false);
        // 0 1 1
        Factuur factuur14 = new Factuur(14, "Auto6", 12100.0, "02-04-2022", false, 0, 2100, administratie, true);
        // 1 0 0
        Factuur factuur15 = new Factuur(15, "Auto4", 12100.0, "02-04-2022", false, 2, 0, administratie, false);
        // 1 0 1
        Factuur factuur16 = new Factuur(16, "Auto5", 12100.0, "02-04-2022", false, 2, 0, administratie, true);
        // 1 1 0
        Factuur factuur17 = new Factuur(17, "Auto6", 12100.0, "02-04-2022", false, 2, 2100, administratie, false);
        // 1 1 1
        Factuur factuur18 = new Factuur(18, "Auto6", 12100.0, "02-04-2022", false, 2, 2100, administratie, true);
