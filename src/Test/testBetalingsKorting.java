...
public class testBetalingsKorting {
    ...
    void testBetalingsKorting() {
        ...
        // 1 1 1 1
        Factuur factuur1 = new Factuur(1, "Auto1", 50, "02-04-2022", false, 0, 0, administratie, false, 14, true, 65);
        // 1 0 0 0
        Factuur factuur2 = new Factuur(2, "Auto2", 50, "02-04-2022", false, 0, 0, administratie, true, 30, false, 30);
        // 1 1 0 0
        Factuur factuur3 = new Factuur(3, "Auto3", 500, "02-04-2022", false, 0, 0, administratie, false, 14, false, 30);
        // 1 0 1 1
        Factuur factuur4 = new Factuur(4, "Auto4", 500, "02-04-2022", false, 0, 0, administratie, true, 30, true, 65);
        // 1 1 1 0
        Factuur factuur5 = new Factuur(5, "Auto5", 1200, "02-04-2022", false, 0, 0, administratie, false, 14, true, 30);
        // 1 0 0 1
        Factuur factuur6 = new Factuur(6, "Auto6", 1200, "02-04-2022", false, 0, 0, administratie, true, 30, false, 65);
